                ...
                <div class="col-12 col-xxl-9 col-lg-8 main-content pt-5 px-5" style="margin: 0 auto;">
                    <div class="d-flex justify-content-between align-items-center mb-4 pt-5">
                        <div class="d-flex gap-2">
                            <button class="btn btn-danger d-flex" id="addNewStudent" data-bs-toggle="modal" data-bs-target="#studentModal">
                                <i class="bi bi-person-plus-fill me-2"></i><span class="d-none d-md-flex">Add New Student</span>
                            </button>
